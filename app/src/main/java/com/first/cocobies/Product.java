...
public class Product extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        myWebView.loadUrl(Urls.product_from_website);
        ...
        swipeRefreshLayout = (SwipeRefreshLayout)view.findViewById(R.id.pullToRefreshproduct);
...
//        data=new ArrayList<>();
//        data.add(new shopbycategory("Lado",R.drawable.lado));
//
//        data.add(new shopbycategory("Ice Cream",R.drawable.icecreamcup));
//        data.add(new shopbycategory("Candy",R.drawable.candy));
